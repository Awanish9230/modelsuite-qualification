...
const inputCls = 'w-full bg-bg-input border border-border rounded-[10px] px-4 py-3 text-[15px] text-text-primary outline-none placeholder:text-text-muted focus:border-primary focus:ring-[3px] focus:ring-primary/20 transition-all duration-200 font-sans hover:border-border-light';
...
const LoginPage = () => {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[480px_1fr]">
      ...
      {/* ── Right: Visual panel ── */}
      <div className="hidden lg:flex flex-col items-center justify-center relative overflow-hidden p-16 animate-fade-in min-h-screen bg-bg-dark"
        ...
        <div className="absolute top-12 right-12 group z-50">
          ...
          {/* Tooltip Popup */}
          <div className="absolute right-0 top-14 w-[340px] p-6 rounded-2xl bg-bg-surface/95 backdrop-blur-xl border border-white/10 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.8)] opacity-0 translate-y-3 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible transition-all duration-300">
            ...
            <ol className="flex flex-col gap-4 relative">
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-100">
                <div className="w-[20px] h-[20px] rounded-full bg-[#10B981] flex-shrink-0 mt-0.5 border-[3px] border-bg-surface relative z-10 shadow-[0_0_12px_rgba(16,185,129,0.5)] animate-pulse"></div>
                <div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-200">
                <div className="w-[20px] h-[20px] rounded-full bg-[#3B82F6] flex-shrink-0 mt-0.5 border-[3px] border-bg-surface relative z-10 shadow-[0_0_12px_rgba(59,130,246,0.5)] animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div>
              ...
              <li className="flex items-start gap-4 relative opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-300">
                <div className="w-[20px] h-[20px] rounded-full bg-[#8B5CF6] flex-shrink-0 mt-0.5 border-[3px] border-bg-surface relative z-10 shadow-[0_0_12px_rgba(139,92,246,0.5)] animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                <div>

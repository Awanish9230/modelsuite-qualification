      ...
      <div className="flex items-center justify-between flex-wrap gap-2 mt-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          {getTaskDueStatus(task.dueDate, task.status) === 'overdue' && (
            <span className="inline-block px-1.5 py-[2px] rounded text-[9px] font-bold badge-overdue uppercase tracking-wider">
              Overdue
            </span>
          )}
          {getTaskDueStatus(task.dueDate, task.status) === 'due-soon' && (
            <span className="inline-block px-1.5 py-[2px] rounded text-[9px] font-bold badge-due-soon uppercase tracking-wider">
              Due Soon
            </span>
          )}
        </div>
